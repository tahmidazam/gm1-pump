...
\begin{abstract}
    ...
    The estimated prototype cost is under 220 GBP, with a final product target of 50--100 GBP, offering a low-cost, reproducible alternative suitable for parallel graft testing.
    >>>>>>> Stashed changes
\end{abstract}
